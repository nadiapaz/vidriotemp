			...
			<div class="gtco-container">
				<div class="row gtco-heading">
					...
					<div class="col-md-3 col-md-push-2 text-center">
						<p class="mt-md"><a href="#" class="btn btn-special btn-block">trabaja con nosotros</a></p>
					</div>
				</div>
				<div class="row">
						...
						<div class="owl-carousel owl-carousel-carousel">
							<div class="item">
								<div class="gtco-staff">
									<img src=" <?php echo get_template_directory_uri(); ?>/images/carnet_1.jpg" alt="" class="img-responsive">
									<h2>Jane Simpson</h2>
							...
							<div class="item">
								<div class="gtco-staff">
									<img src="<?php echo get_template_directory_uri(); ?>/images/carnet2.jpg" alt="" class="img-responsive">
							...
							<div class="item">
								<div class="gtco-staff">
									<img src="<?php echo get_template_directory_uri(); ?>/images/carnet3.jpg" alt="" class="img-responsive">
			...
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-6 gtco-news">
						...
						<p><a href="#" class="btn btn-sm btn-special">Más noticias</a></p>
					</div>
					<!-- END News -->
